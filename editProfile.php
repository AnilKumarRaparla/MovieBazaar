...
<head>
    ...
    <title>Edit Profile - Movie Ticket Booking System</title>
...
<body>
    ...
    <main class="main-content">
        <section class="user-info">
            <img src="C:\Users\Anil\Desktop\Hello\OIP (7).jpeg" alt="Profile" class="profile-image">
        ...
        <section id="editProfile" class="section" style="margin-left: 12.5%;">
            <h3 class="section__title">Edit Profile</h3>
            <form class="edit-profile-form">
                <label for="name">Name:</label>
                <input type="text" id="name" name="name" value="Anil Kumar Raparla">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="anilkumarraparla@outlook.com">
