...
<head>
    ...
    <title>Help - Movie Ticket Booking System</title>
...
<body>
    ...
    <main class="main-content">
        <section class="help-section" style="margin-left: 12.5%;">
            <h2 class="section__title">Help</h2>
            <p>If you need assistance, please contact our support team:</p>
            <p>Email: support@moviebazaar.com</p>
